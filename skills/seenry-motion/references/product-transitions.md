...
| Menu opens | Place it beside the trigger; transform origin at the attaching edge. A proposed starting recipe is opacity plus scale .98 to 1 over 160ms ease-out; close around 100ms. | Focus must move immediately, even during the entrance. Escape returns it. Keep DOM until the visual exit settles, while making closing content inert. Cancel stale close completion on reopening. |
