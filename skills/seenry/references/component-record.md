# A component DESIGN.md

Keep this record short and proportional to the task. Write it before product code; update it from rendered decisions. Do not turn the record into labels inside the component.
