...
The substantive bar comes from the project's motion principles (animations.dev). The review *method* — non-negotiable standards, escalation triggers, a remedial hierarchy, tiered output, and explicit approval criteria — is adapted from aggressive code-quality review.
...
2. **Frequency-appropriate.** Match motion to how often it's seen. Frequently repeated actions default to immediate or minimal feedback. Tens/day gets reduced motion. Occasional gets standard. Rare/first-time can have delight.
