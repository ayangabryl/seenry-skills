...
The eight audit categories, what to look for in each, and the exact target values to cite in findings and plans. Adapted motion audit criteria; provenance is recorded in the distribution notices. Treat numerical values as documented starting points; preserve the project’s verified tokens.
...
| Frequency | Decision |
| --- | --- |
| 100+ times/day (keyboard shortcuts, command palette toggle) | Prefer immediate or minimal feedback. |
