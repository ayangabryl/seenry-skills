...
| Frequency | Verdict |
| --- | --- |
| 100+ times/day (keyboard shortcuts, command palette, core navigation) | Prefer immediate feedback; justify any transition. |
...
- `CommandMenu.tsx:12` — command palette open/close. **Prefer immediate feedback: this frequently repeated action has no demonstrated need for a transition.**
