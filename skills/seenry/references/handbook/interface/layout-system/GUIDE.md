...
Hit areas and focus behavior belong to `accessibility`. Radius, shadows and animation belong to `control-craft`. Line length and text spacing belong to `type-system`.
